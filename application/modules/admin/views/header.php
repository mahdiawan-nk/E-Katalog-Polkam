...
<head>
    ...
    <!-- Argon CSS -->
    <link rel="stylesheet" href="<?php echo get_theme_uri('css/argon9f1e.css', 'argon'); ?>" type="text/css">
...
<body class="g-sidenav-hidden   bg-gray-100">
    <!-- Sidenav -->
    <nav class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-0 fixed-start ms-4" id="sidenav-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('admin/products'); ?>">
                                ...
                                <span class="nav-link-text">Kelola Katalog</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('admin/settings/profile'); ?>" class="dropdown-item">
                                <i class="ni ni-single-02"></i>
                                <span class="nav-link-text">Kelola Profil</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('admin/settings'); ?>" class="dropdown-item">
                                <i class="ni ni-settings-gear-65"></i>
                                <span class="nav-link-text">Pengaturan Website</span>
                            </a>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('admin/jasa'); ?>">
                                <i class="fa fa-shopping-cart text-success"></i>
    ...
    <!-- Main content -->
    <main class="container-xl" id="panel">
        <!-- Topnav -->
        <nav class="navbar navbar-top navbar-expand navbar-dark border-bottom" style="background-color: #ff7f00; color: white;">
