    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <h3 style="color: #ff7f00; text-align: center;">Halaman Katalog Produk</h3>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <h3 style="color: #ff7f00; text-align: center;">KATALOG PRODUK POLITEKNIK KAMPAR</h3>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate" >
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <!-- <div class="bottom-area d-flex px-3" style="display: none">
                                    <div class="m-auto d-flex">
                                        <a href="<?php echo site_url('shop/product/' . $product->id . '/' . $product->sku . '/'); ?>"
                                            class="buy-now d-flex justify-content-center align-items-center text-center">
                                            <span><i class="ion-ios-menu" hidden=""></i></span>
                                        </a>
                                        <a href="#"
                                            ...
                                            <span><i class="ion-ios-cart" hidden></i></span>
                                        </a>
                                    </div>
                                </div> -->
                            </div>
