            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        ...
                        <li class="ftco-animate"><a href="https://www.instagram.com/politeknikkampar/"><span class="icon-instagram"></span></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-5">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo site_url('pages/produk'); ?>" class="py-2 d-block">Katalog Produk</a></li>
                        <li><a href="<?php echo site_url('pages/jasa'); ?>" class="py-2 d-block">Katalog Jasa</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><a href="https://goo.gl/maps/wKX5EJtYqdx2o3A16"><span
                                        class="icon icon-map-marker"></span><span
                                        class="text"><?php echo get_settings('store_address'); ?></span></a></li>
                            <li><a href="tel:085376621945"><span class="icon icon-phone"></span><span
                                        class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
                            <li><a href="mailto:polkam@poltek-kampar.ac.id"><span class=" icon icon-envelope"></span><span
